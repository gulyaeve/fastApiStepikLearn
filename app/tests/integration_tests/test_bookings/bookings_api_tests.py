...
@pytest.mark.parametrize(
    "room_id,date_from,date_to,status_code_create,status_code_read,status_code_delete,"
    "status_code_check",
    [
...
async def test_crud_booking(
    ...
    new_booking = await authenticated_ac.post(
        "/bookings",
        params={
            "room_id": room_id,
            "date_from": date_from,
    ...
    if new_booking.status_code == status_code_create:
        ...
        response_del = await authenticated_ac.delete(
